...
insert into playerdata values('CA001','msd7','SP101','','M','INDIAN','100000','03MAR97');
insert into playerdata values('CA002','vk18','SP101','','Male','INDIAN','100000','06DEC89');
insert into playerdata values('CA004','klrahul','SP101','','M','INDIAN','99000','04JAN90');
insert into playerdata values('BA002','kingJames','SP102','','M','AMERICAN','199000','23OCT97');
insert into playerdata values('BA003','sc30','SP102','','M','SERBIAN','112000','17MAR97');
insert into playerdata values('BA004','kd35','SP102','','M','BRITISH','123000','29FEB96');
insert into playerdata values('BA005','kobebryant','SP102','','M','NIGERIAN','102200','26SEP89');
insert into playerdata values('BA006','illuminati2','SP102','','M','AUSTRALIAN','120000','31DEC85');
insert into playerdata values('BA007','pg13','SP102','','M','PAKISTANI','100000','18AUG93');
insert into playerdata values('BA008','westbrook0','SP102','','M','BANGLADESHI','110000','19JUL93');
insert into playerdata values('BA009','ad3','SP102','','M','AMERICAN','100000','28MAR90');
insert into playerdata values('BA010','alexcaruso','SP102','','M','MEXICAN','123000','20JUN92');
insert into playerdata values('BA011','jimmybutler','SP102','','M','AMERICAN','113500','19OCT90');
insert into playerdata values('BA012','derozan','SP102','','M','AMERICAN','123400','16JUL94');
